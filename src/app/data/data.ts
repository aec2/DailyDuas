...
export const PRAYERS: Prayer[] = [
  ...
  {
    id: 6,
    title: "Allah'ın Kelimeleriyle Sığınmak",
    category: "Koruma",
    time: "Akşam",
  ...
  {
    id: 15,
    title: "Haşr Sûresi Son Ayetleri",
    category: "Kurani",
    time: "Sabah",
    arabic: "أَعُوذُ بِاللَّهِ السَّمِيعِ الْعَلِيمِ مِنَ الشَّيْطَانِ الرَّجِيمِ (3 defa) + هُوَ اللَّهُ الَّذِي لَا إِلَهَ إِلَّا هُوَ عَالِمُ الْغَيْبِ وَالشَّهَادَةِ...",
  ...
  {
    id: 17,
    title: "Tam Koruma Duası",
    category: "Koruma",
    time: "Her Zaman",
    arabic: "بِسْمِ اللَّهِ عَلَى نَفْسِي وَدِينِي بِسْمِ اللَّهِ عَلَى أَهْلِي وَمَالِي...",
    transliteration: "Bismillâhi alâ nefsî ve dînî, bismillâhi alâ ehlî ve mâlî ve veledî...",
  ...
  {
    id: 19,
    title: "Rum Sûresi Ayetleri",
    category: "Kurani",
    time: "Sabah & Akşam",
    arabic: "فَسُبْحَانَ اللَّهِ حِينَ تُمْسُونَ وَحِينَ تُصْبِحُونَ * وَلَهُ الْحَمْدُ فِي السَّمَاوَاتِ وَالْأَرْضِ...",
    transliteration: "Fe-sübhânallâhi hîne tümsûne ve hîne tusbihûn. Ve lehül hamdü fis-semâvâti vel ardi ve aşiyyen ve hîne tuzhirûn...",
